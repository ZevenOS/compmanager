...
class PreferencesCompmanagerDialog(gtk.Dialog):
    __gtype_name__ = "PreferencesCompmanagerDialog"
    preferences = {}
    ...
    def __new__(cls):
        ...
        Returns a fully instantiated PreferencesCompmanagerDialog object.
        """
        builder = get_builder('PreferencesCompmanagerDialog')
        new_object = builder.get_object("preferences_compmanager_dialog")
    ...
    def finish_initializing(self, builder):
        ...
        and creating a PreferencesCompmanagerDialog object with it in order to
        finish initializing the start of the new PerferencesCompmanagerDialog
        instance.
...
if __name__ == "__main__":
    dialog = PreferencesCompmanagerDialog()
    dialog.show()
    gtk.main()
